...
export const translations = {
  uz: {
    ...
    products: {
      ...
      notFoundDesc: 'Boshqa kalit so\'zlar bilan qidirib ko\'ring',
      volumes: 'Hajmlar'
    },
    contact: {
      title: 'Biz bilan bog\'laning',
      desc: 'Mahsulotlar haqida savollaringiz bormi? Yoki hamkorlik taklif qilmoqchimisiz? Bizning maslahatchilarimiz sizga yordam berishga doim tayyor.',
      companyLabel: 'Kompaniya',
      workingHoursLabel: 'Ish vaqti',
      workingHours: 'Dushanba - Shanba, 09:00 - 18:00',
      telegramTitle: 'Telegram Bot orqali buyurtma',
      telegramSubtitle: 'Mijozlar uchun 24/7 faol buyurtma xizmati',
      ...
      formMessageLabel: 'Xabaringiz',
      formMessagePlaceholder: 'Sizni qiziqtirgan savolni yozing',
      formSubmit: 'Xabarni yuborish',
      formSubmitting: 'Yuborilmoqda...',
      formSuccessTitle: 'Xabar yuborildi!',
      formSuccessDesc: 'Tez orada siz bilan bog\'lanamiz.',
      formError: 'Xatolik yuz berdi. Qayta urinib ko\'ring.',
      certText: 'ISO 9001:2015 xalqaro talablari va eng yuqori standartlar asosida sertifikatlangan.'
    },
    footer: {
  ...
  ru: {
    ...
    products: {
      ...
      notFoundDesc: 'Попробуйте другие ключевые слова',
      volumes: 'Объемы'
    },
    contact: {
      title: 'Свяжитесь с нами',
      desc: 'Есть вопросы о продукции? Или хотите предложить сотрудничество? Наши консультанты всегда готовы помочь.',
      companyLabel: 'Компания',
      workingHoursLabel: 'Время работы',
      workingHours: 'Понедельник - Суббота, 09:00 - 18:00',
      telegramTitle: 'Заказ через Telegram Bot',
      telegramSubtitle: 'Круглосуточный сервис заказов для клиентов',
      formTitle: 'Оставьте сообщение',
      formNameLabel: 'Ваше имя',
      formNamePlaceholder: 'Введите ваше имя',
      formPhoneLabel: 'Номер телефона',
      formPhonePlaceholder: '+998 (90) 123-45-67',
      formMessageLabel: 'Ваше сообщение',
      formMessagePlaceholder: 'Напишите интересующий вас вопрос',
      formSubmit: 'Отправить сообщение',
      formSubmitting: 'Отправляется...',
      ...
      certText: 'Сертифицировано по международным стандартам ISO 9001:2015 и высшим требованиям качества.'
    },
    footer: {
  ...
  en: {
    ...
    products: {
      ...
      notFoundDesc: 'Try different keywords',
      volumes: 'Volumes'
    },
    contact: {
      title: 'Get in Touch',
      desc: 'Have questions about our products? Or want to propose a partnership? Our consultants are always ready to help.',
      companyLabel: 'Company',
      workingHoursLabel: 'Working Hours',
      workingHours: 'Monday - Saturday, 09:00 - 18:00',
      telegramTitle: 'Order via Telegram Bot',
      telegramSubtitle: '24/7 order service for customers',
      ...
      formMessagePlaceholder: 'Write your question here',
      formSubmit: 'Send Message',
      formSubmitting: 'Sending...',
      formSuccessTitle: 'Message Sent!',
      formSuccessDesc: 'We will get back to you soon.',
      formError: 'An error occurred. Please try again.',
      certText: 'Certified to international ISO 9001:2015 standards and the highest quality requirements.'
    },
    footer: {
